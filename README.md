...
**[中文版 Chinese README 请点击这里 🇨🇳](https://github.com/tanfengshuang/tanfengshuang.github.io/README-zh-cn.md)**
...
**My Blog Url: [http://tanfengshuang.github.io/](http://tanfengshuang.github.io/)**. If you like this theme, you can give me a star to encourage me. Welcome everyone to use it.
...
# Site settings
title: Shuang
brief-intro: Quality Engineer
baseurl: "" # the subpath of your site, e.g. /blog
url: "http://tanfengshuang.github.io" # the base hostname & protocol for your site
```
...
```yml
# other links
github_username:  tanfengshuang
email: tanfengshuang@163.com

description_footer: 学习笔记...
```
...
* Created my own blog by refering to http://gaohaoyang.github.io/


## License

[MIT License](https://github.com/tanfengshuang/tanfengshuang.github.io/blob/master/LICENSE)
